...
//         } else {
//             $roleId = $this->input->post('roleid');
//             $roleInfo = array('isDeleted' => 0, 'updatedBy' => $this->vendorId, 'updatedDtm' => date('Y-m-d H:i:s'));
    
// echo($roleId);

//            // $result = $this->role_model->deleteRole($roleId, $roleInfo); // Change 'deleteUser' to 'deleteRole'
