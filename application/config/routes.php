<?php
defined('BASEPATH') OR exit('No direct script access wwwwwwallowed');
...
//$route['deleteRole'] = 'roles/roleListing';
//$route['deleteRole/(:num)'] = "roles/roleListing/$1";


$route['deleteBooking'] = "booking/deleteBooking";
//$route['deletebooking/(:num)'] = "roles/bookingListing/$1";
